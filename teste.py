...
url = 'https://sicnet2.aneel.gov.br/sicnetweb/pdf_consolidar.aspx?cod_protocolo=4675264&cod_id_usuario_externo=17939526&txt_email=paulo.renato.reche@gmail.com'
url2 = 'https://sicnet2.aneel.gov.br/sicnetweb/pdf_consolidar.aspx?cod_protocolo=4241093&cod_id_usuario_externo=17939526&txt_email=paulo.renato.reche@gmail.com'
r = requests.get(url, verify=False) ## Ignorando validação do certificado SSL
print(r.text)
